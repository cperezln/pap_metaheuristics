...
## Load data
setwd("D:/OneDrive - Universidad Rey Juan Carlos/Work/6. Investigacion/Work/Ranking_Bayesiano_algoritmos")
df <- read.csv("appendix_A_table_other_methods_native.csv")
#library("readxl")
